...
jsonSource_ReddingCityBoundary_1.addFeatures(features_ReddingCityBoundary_1);var lyr_ReddingCityBoundary_1 = new ol.layer.Vector({
            ...
            });var format_CommercialZones_2 = new ol.format.GeoJSON();
var features_CommercialZones_2 = format_CommercialZones_2.readFeatures(json_CommercialZones_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CommercialZones_2 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_CommercialZones_2.addFeatures(features_CommercialZones_2);var lyr_CommercialZones_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CommercialZones_2, 
                style: style_CommercialZones_2,
                title: '<img src="styles/legend/CommercialZones_2.png" /> Commercial Zones'
            });var format_CommercialParcels_3 = new ol.format.GeoJSON();
var features_CommercialParcels_3 = format_CommercialParcels_3.readFeatures(json_CommercialParcels_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CommercialParcels_3 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_CommercialParcels_3.addFeatures(features_CommercialParcels_3);var lyr_CommercialParcels_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CommercialParcels_3, maxResolution:2.80044661523,

                style: style_CommercialParcels_3,
                title: '<img src="styles/legend/CommercialParcels_3.png" /> Commercial Parcels'
...
lyr_NAIP_2016_0.setVisible(true);lyr_ReddingCityBoundary_1.setVisible(true);lyr_CommercialZones_2.setVisible(true);lyr_CommercialParcels_3.setVisible(true);lyr_RoadLabels_4.setVisible(true);lyr_1000ftBuffer_5.setVisible(true);lyr_Schools_6.setVisible(true);
var layersList = [lyr_NAIP_2016_0,lyr_ReddingCityBoundary_1,lyr_CommercialZones_2,lyr_CommercialParcels_3,lyr_RoadLabels_4,lyr_1000ftBuffer_5,lyr_Schools_6];
...
lyr_CommercialZones_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'ZONING': 'ZONING', 'Z_CLASS': 'Z_CLASS', 'Z_DESC': 'Z_DESC', 'ZONE_ID': 'ZONE_ID', 'BASE_DIST': 'BASE_DIST', 'OVERLAY_DI': 'OVERLAY_DI', 'OVERLAY__1': 'OVERLAY__1', 'Z_DESC2': 'Z_DESC2', 'Shape__Are': 'Shape__Are', 'Shape__Len': 'Shape__Len', });
lyr_CommercialParcels_3.set('fieldAliases', {'APN': 'APN', 'ID': 'ID', 'Perimeter': 'Perimeter', 'Area_': 'Area_', 'Acres': 'Acres', 'SHAPE_STAr': 'SHAPE_STAr', 'SHAPE_STLe': 'SHAPE_STLe', });
...
lyr_CommercialZones_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'ZONING': 'TextEdit', 'Z_CLASS': 'TextEdit', 'Z_DESC': 'TextEdit', 'ZONE_ID': 'TextEdit', 'BASE_DIST': 'TextEdit', 'OVERLAY_DI': 'TextEdit', 'OVERLAY__1': 'TextEdit', 'Z_DESC2': 'TextEdit', 'Shape__Are': 'TextEdit', 'Shape__Len': 'TextEdit', });
lyr_CommercialParcels_3.set('fieldImages', {'APN': 'TextEdit', 'ID': 'TextEdit', 'Perimeter': 'TextEdit', 'Area_': 'TextEdit', 'Acres': 'TextEdit', 'SHAPE_STAr': 'TextEdit', 'SHAPE_STLe': 'TextEdit', });
...
lyr_CommercialZones_2.set('fieldLabels', {'OBJECTID': 'no label', 'ZONING': 'no label', 'Z_CLASS': 'no label', 'Z_DESC': 'no label', 'ZONE_ID': 'no label', 'BASE_DIST': 'no label', 'OVERLAY_DI': 'no label', 'OVERLAY__1': 'no label', 'Z_DESC2': 'no label', 'Shape__Are': 'no label', 'Shape__Len': 'no label', });
lyr_CommercialParcels_3.set('fieldLabels', {'APN': 'no label', 'ID': 'no label', 'Perimeter': 'no label', 'Area_': 'no label', 'Acres': 'no label', 'SHAPE_STAr': 'no label', 'SHAPE_STLe': 'no label', });
